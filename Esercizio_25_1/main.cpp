 ...
 * @date    12/02/2024
 * @brief   In chapter 23 there is a program to print an histogram which uses
 *          the infinite array for this example. Rewrite the program by using
 *          the STL library.
 *          Generates an histogram of an array of numbers.
 *          `main <file>`
